...
function DrawerOverlay({
  ...
  return (
    <DrawerPrimitive.Overlay
      ...
      className={cn("fixed inset-0 bg-ink/60 z-40", className)}
      {...props}
    />
  );
}
  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content bg-white fixed z-50 flex h-auto flex-col shadow-xl",
        ...
        {...props}
      >
        <div className="bg-base-lighter mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block" />
        {children}
      </DrawerPrimitive.Content>
    </DrawerPortal>
  );
...
function DrawerTitle({
  ...
  return (
    <DrawerPrimitive.Title
      ...
      className={cn("text-2xl font-bold font-sans text-ink", className)}
      {...props}
    />
  );
}
...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn("text-base text-base-dark", className)}
      {...props}
    />
  );
}
